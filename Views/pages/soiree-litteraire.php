...
<body style=" background-color: #bb2626;">
    <?php
...
?>
    ...
    </div>   <div class="TitleOfSection" style="text-align:center; margin-bottom:40px; padding-top:170px; color:#000000;">
...
<h1 style="font-size: 45px;
    ...
    color: #ffffffb9;
    margin: 0px 0;;">Soirée litteraire </h1>
  ...
  font-weight: 500;
    ...
    color: rgba(225, 219, 219, 0.99);">
      BIENVENU à notre soirée
    </span>
