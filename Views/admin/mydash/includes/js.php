  ...
  <script src="Views/admin/assets/vendors/jquery-bar-rating/jquery.barrating.min.js"></script>
  <script src="Views/admin/assets/vendors/chart.js/Chart.min.js"></script>
  <script src="Views/admin/assets/vendors/flot/jquery.flot.js"></script>
  <script src="Views/admin/assets/vendors/flot/jquery.flot.resize.js"></script>
  <script src="Views/admin/assets/vendors/flot/jquery.flot.categories.js"></script>
  <script src="Views/admin/assets/vendors/flot/jquery.flot.fillbetween.js"></script>
  <script src="Views/admin/assets/vendors/flot/jquery.flot.stack.js"></script>
  ...
  <script src="Views/admin/assets/js/settings.js"></script>
  ...
  window.history.replaceState( null, null, window.location.href );
    ...
    $(document).ready(function () {
      ...
      function getDatas() {
        $.post('Views/admin/mydash/snipets/categories.php', function (data) {
          $('#getlist').html(data);
        });
      };
